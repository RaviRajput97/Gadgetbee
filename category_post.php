			...
			<div class="clearfix wrapper main_content_area">
				...
				<div class="clearfix main_content floatleft">
					...
					<div class="clearfix content">
						<div class="content_title"><h2>Blog Posts On Brands</h2></div>
					...
					<!--loop start here-->
						...
						<?php 
						$cat = $_REQUEST['cat'];
						$sel_q = mysql_query("SELECT mp.*,ad.a_name FROM  main_post mp inner join admin ad on mp.add_by=ad.id  where mp.status=1 and mp.brand='".$cat."' order by mp.id desc ");
