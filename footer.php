			...
			<div class="clearfix wrapper footer_top">
				<div class="clearfix footer_top_container">
					<div class="clearfix single_footer_top floatleft">
						<h2>Contact Us</h2>
						<p>Phone-011-22320989
						<br>Email-admin@gadgetbee.in</p>
					</div>
					<div class="clearfix single_footer_top floatleft">
						<h2>Recent Post</h2>
						<p><a href="http://localhost/gadgetbee/single-works.php?id=14">Iphone 7 Plus </a></p>
						<p><a href="http://localhost/gadgetbee/single-works.php?id=17">Oneplus 3 </a></p>
					</div>
					<div class="clearfix single_footer_top floatleft">
						<h2>Useful Links</h2>
						<ul>
							<li><a href="https://techhill360.blogspot.in/">Techhill360</a></li>
							<li><a href="http://apkhub4u.blogspot.in/">ApkHub</a></li>
		...
		<section id="footer_bottom_area">
			<div class="clearfix wrapper footer_bottom">
				<div class="clearfix copyright floatleft">
					<p> Copyright &copy; All rights reserved by <span>GadgetBee.in</span></p>
				</div>
